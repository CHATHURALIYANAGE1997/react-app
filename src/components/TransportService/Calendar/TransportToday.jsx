...
const TransportToday = () => {
    return (
        <div class="today-container w-100">
            <div className="d-flex flex-column transport-today-card">
                <div className="d-flex flex-row justify-content-between">
                    <h5 className="transport-today-title">Today</h5>
                    <h7 className="transport-today-date">27th July 2022</h7>
                </div>
                <h7>Starting : </h7>
                <h7>Ending : </h7>
                <h3 className="transport-today-trip">Trip to Hanthana</h3>
                <div className="today-transport mb-3 d-flex flex-row">
                    <div className="d-flex flex-column w-50 text-left">
                        <h6 className="transport-today-transport-mode">Transport</h6>
                        <div>
